...
const RealFormobjectifScreen = props => {
          ...
          onPress={() => {
            const handler = async () => {
              try {
                ...
                navigation.navigate('RealFormpreferenceScreen');
              } catch (err) {
                console.error(err);
              }
            };
...
export default withTheme(RealFormobjectifScreen);
